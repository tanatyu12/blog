...
`;
        expect(_reactTestRenderer.default.create(_react.default.createElement(_MarkdownPreview.default, {
          value: (0, _serializers.markdownToHtml)(value)
    ...
    describe('Headings', () => {
      for (const heading of [...Array(6).keys()]) {
        it(`should render Heading ${heading + 1}`, () => {
          const value = (0, _padStart2.default)(' Title', heading + 7, '#');
          expect(_reactTestRenderer.default.create(_react.default.createElement(_MarkdownPreview.default, {
            value: (0, _serializers.markdownToHtml)(value)
          })).toJSON()).toMatchSnapshot();
        });
