...
const styleStrings = {
  label: `
    color: ${_netlifyCmsUiDefault.colors.controlLabel};
    background-color: ${_netlifyCmsUiDefault.colors.textFieldBorder};
    ...
    padding: 3px 6px 2px;
    margin: 0;
    transition: all ${_netlifyCmsUiDefault.transitions.main};
    position: relative;
  ...
  `,
  labelActive: `
    background-color: ${_netlifyCmsUiDefault.colors.active};
    color: ${_netlifyCmsUiDefault.colors.textLight};
  `,
  labelError: `
    background-color: ${_netlifyCmsUiDefault.colors.errorText};
    color: ${_netlifyCmsUiDefault.colorsRaw.white};
  `,
  widget: `
    display: block;
    width: 100%;
...
class EditorControl extends _react.default.Component {
  ...
  render() {
    const _this$props = this.props,
          ...
          mediaPaths = _this$props.mediaPaths,
          boundGetAsset = _this$props.boundGetAsset,
          _onChange = _this$props.onChange,
          openMediaLibrary = _this$props.openMediaLibrary,
          clearMediaControl = _this$props.clearMediaControl,
          removeMediaControl = _this$props.removeMediaControl,
          addAsset = _this$props.addAsset,
          removeInsertedMedia = _this$props.removeInsertedMedia,
          onValidate = _this$props.onValidate,
          processControlRef = _this$props.processControlRef,
          controlRef = _this$props.controlRef,
          query = _this$props.query,
          queryHits = _this$props.queryHits,
          isFetching = _this$props.isFetching,
          clearSearch = _this$props.clearSearch,
          clearFieldErrors = _this$props.clearFieldErrors,
          loadEntry = _this$props.loadEntry,
          t = _this$props.t;
    ...
    return (0, _core.jsx)(_core.ClassNames, null, (_ref) => {
      ...
      return (0, _core.jsx)(ControlContainer, null, widget.globalStyles && (0, _core.jsx)(_core.Global, {
        ...
        className: cx(css`
                  ${styleStrings.label};
                `, this.state.styleActive && css`
                    ${styleStrings.labelActive};
                  `, !!errors && css`
                    ${styleStrings.labelError};
                  `),
        htmlFor: this.uniqueFieldId
      }, `${field.get('label', field.get('name'))}${isFieldOptional ? ' (optional)' : ''}`), (0, _core.jsx)(_Widget.default, {
