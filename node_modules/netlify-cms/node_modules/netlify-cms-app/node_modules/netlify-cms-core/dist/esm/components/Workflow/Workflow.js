...
class Workflow extends _react.Component {
  componentDidMount() {
    const _this$props = this.props,
          loadUnpublishedEntries = _this$props.loadUnpublishedEntries,
          isEditorialWorkflow = _this$props.isEditorialWorkflow,
  ...
  render() {
    const _this$props2 = this.props,
          isEditorialWorkflow = _this$props2.isEditorialWorkflow,
          isFetching = _this$props2.isFetching,
          unpublishedEntries = _this$props2.unpublishedEntries,
          updateUnpublishedEntryStatus = _this$props2.updateUnpublishedEntryStatus,
          publishUnpublishedEntry = _this$props2.publishUnpublishedEntry,
          deleteUnpublishedEntry = _this$props2.deleteUnpublishedEntry,
